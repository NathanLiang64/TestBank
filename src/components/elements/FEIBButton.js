...
const StyledButton = styled(FEIBdefaultButton).attrs({ className: 'Button' })`
...
const FEIBButton = (props) => {
  const buttonDisabled = useSelector((state) => state.ModalReducer.buttonDisabled);
  return <StyledButton disabled={buttonDisabled} {...props} />;
};
