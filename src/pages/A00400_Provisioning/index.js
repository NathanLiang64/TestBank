      ...
      <ProvisioningWrapper>
        ...
        <Accordion title="服務條款" space="both" open>
          <div className="dealContent">
            ...
            <br />
            <p>
              遠銀為提供金融服務內容，請客戶提供公司 / 個人資料，如：公司名稱、姓名、統一編號、身分證統一編號、出生年月日、住址以及任何客戶辨識等資料，因服務之提供而獲得有關客戶的帳務、信用、投資或保險等資料，如非經過客戶的同意、授權或因其他法律上的規定，遠銀不會將客戶非公開之資料透露給無關之第三者知悉。
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              <a href="https://www.feib.com.tw/detail?id=325">https://www.feib.com.tw/detail?id=325</a>
            </p>
            <br />
            <p>
              如有疑慮，請洽本行客服專線: https://www.feib.com.tw/tel
            </p>
            <br />
            <p>
            ...
            <p>
              部分功能需要使用定位服務，如鄰近分行/ATM。
            </p>
            <p>
              部分功能需要設定接收及提示燈號服務，如推播通知。
            </p>
            <p>
              部分功能需要取得您的手機狀態，如行動守護精靈MOTP。
            </p>
            <p>
              部分功能需要取用您的通知功能，允許應用程式接收與顯示推播訊息。
            </p>
            <p>
              部分功能需要取用您的存取儲存空間功能，如儲存畫面功能。
            </p>
          </div>
        </Accordion>
